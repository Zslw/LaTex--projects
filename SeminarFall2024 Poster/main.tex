...
\begin{multicols}{2}
	...
	\begin{minipage}[t]{0.23\textwidth}
		...
		Figure 1: Epicardial pacing leads on the heart's surface, used post-surgery for arrhythmia management.\cite{Russell2012}}
		 \label{fig:epicardial_leads} % Add a label for referencing
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		% Image
		\node[anchor=north west] at (-12, 0) {\includegraphics[width=0.36 \linewidth, angle =-90]{MRIRisks.PNG}};
		
        % Itemized Overlay
\node[anchor=north west, align=left, text width=8.7cm] at (4, -1) { % Adjust position and width
	\textbf{Key Risks:}
...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{9.5cm}|
        ...
        \hline
        Magnetic Resonance in Medicine (2021) \cite{nguyen2021} & 
        Simulation/ Phantom & 
